...
export const scienceLevels = [
  // ─── CE2 ─────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'sce2-1-t1', type: 'timed', question: 'Reponds vite ! Les besoins des etres vivants', challenges: [{ q: 'De quoi une plante a-t-elle besoin pour pousser ?', answer: 'Eau, lumiere et sels mineraux', options: ['Eau, lumiere et sels mineraux', 'Viande et lait', 'Vent et neige', 'Feu et glace'] }, { q: 'Un animal qui mange uniquement des plantes est :', answer: 'un herbivore', options: ['un carnivore', 'un herbivore', 'un omnivore', 'un insectivore'] }, { q: 'Quel gaz les plantes absorbent-elles ?', answer: 'le dioxyde de carbone (CO2)', options: ['l\'oxygene', 'le dioxyde de carbone (CO2)', 'l\'azote', 'l\'helium'] }, { q: 'Les etres vivants ont besoin d\'eau pour :', answer: 'survivre et faire fonctionner leur corps', options: ['survivre et faire fonctionner leur corps', 'se colorer', 'devenir plus lourds', 'faire du bruit'] }, { q: 'Un etre vivant qui mange des plantes ET des animaux est :', answer: 'un omnivore', options: ['un herbivore', 'un carnivore', 'un omnivore', 'un decomposeur'] }], timeLimit: 50, xp: 25 },
    ],
  },
  {
  ...
  // ─── CM1 ─────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'scm1-1-t1', type: 'timed', question: 'Reponds vite ! Les etats de la matiere et le cycle de l\'eau', challenges: [{ q: 'Quels sont les trois etats de la matiere ?', answer: 'Solide, liquide, gazeux', options: ['Solide, liquide, gazeux', 'Chaud, froid, tiede', 'Dur, mou, flexible', 'Lourd, leger, moyen'] }, { q: 'Comment s\'appelle le passage de l\'eau liquide a la glace ?', answer: 'la solidification', options: ['la fusion', 'la solidification', 'l\'evaporation', 'la condensation'] }, { q: 'A quelle temperature l\'eau bout-elle ?', answer: '100°C', options: ['0°C', '50°C', '100°C', '200°C'] }, { q: 'La vapeur d\'eau qui redevient liquide, c\'est :', answer: 'la condensation', options: ['l\'evaporation', 'la solidification', 'la condensation', 'la fusion'] }, { q: 'Dans le cycle de l\'eau, que forme la vapeur d\'eau en altitude ?', answer: 'des nuages', options: ['des rivieres', 'des nuages', 'de la neige', 'des lacs'] }], timeLimit: 50, xp: 25 },
    ],
  },
  {
  ...
  // ─── CM2 ─────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'scm2-1-t1', type: 'timed', question: 'Reponds vite ! Les energies et l\'environnement', challenges: [{ q: 'Quelle energie utilise la force du vent ?', answer: 'l\'energie eolienne', options: ['l\'energie solaire', 'l\'energie eolienne', 'l\'energie hydraulique', 'l\'energie nucleaire'] }, { q: 'Le petrole est une energie :', answer: 'fossile', options: ['renouvelable', 'fossile', 'nucleaire', 'solaire'] }, { q: 'Les panneaux photovoltaiques transforment quoi en electricite ?', answer: 'la lumiere du soleil', options: ['le vent', 'la lumiere du soleil', 'la chaleur de la terre', 'l\'eau de pluie'] }, { q: 'Quel est le principal probleme des energies fossiles ?', answer: 'la pollution et le rechauffement climatique', options: ['elles sont trop abondantes', 'la pollution et le rechauffement climatique', 'elles sont gratuites', 'elles sont trop propres'] }, { q: 'Un barrage hydroelectrique utilise la force de :', answer: 'l\'eau', options: ['le vent', 'le soleil', 'l\'eau', 'la vapeur'] }], timeLimit: 50, xp: 25 },
    ],
  },
  {
  ...
  // ─── 6eme ────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 's6e-1-t1', type: 'timed', question: 'Reponds vite ! Les etres vivants et la classification', challenges: [{ q: 'Quelle est l\'unite de base de tous les etres vivants ?', answer: 'la cellule', options: ['l\'atome', 'la cellule', 'l\'organe', 'la molecule'] }, { q: 'Un etre vivant compose d\'une seule cellule est dit :', answer: 'unicellulaire', options: ['pluricellulaire', 'unicellulaire', 'multicellulaire', 'acellulaire'] }, { q: 'Le noyau de la cellule contient :', answer: 'l\'ADN', options: ['de l\'eau', 'l\'ADN', 'du sang', 'des vitamines'] }, { q: 'Quel instrument permet d\'observer les cellules ?', answer: 'le microscope', options: ['le telescope', 'le microscope', 'la loupe', 'le stethoscope'] }, { q: 'Les vertebres sont des animaux qui possedent :', answer: 'une colonne vertebrale', options: ['des ailes', 'une colonne vertebrale', 'des antennes', 'une coquille'] }], timeLimit: 50, xp: 25 },
    ],
  },
  {
  ...
  // ─── 5eme ────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 's5e-1-t1', type: 'timed', question: 'Reponds vite ! Melanges, corps humain et nutrition', challenges: [{ q: 'Un melange ou on ne distingue pas les composants est dit :', answer: 'homogene', options: ['heterogene', 'homogene', 'gazeux', 'solide'] }, { q: 'Quelle technique permet de separer le sable de l\'eau ?', answer: 'la filtration', options: ['l\'evaporation', 'la filtration', 'la condensation', 'la distillation'] }, { q: 'L\'appareil respiratoire sert a echanger :', answer: 'l\'oxygene et le dioxyde de carbone', options: ['l\'eau et le sucre', 'l\'oxygene et le dioxyde de carbone', 'le sang et la lymphe', 'les vitamines et les mineraux'] }, { q: 'Ou se fait l\'absorption des nutriments dans le corps ?', answer: 'dans l\'intestin grele', options: ['dans l\'estomac', 'dans l\'intestin grele', 'dans la bouche', 'dans le coeur'] }, { q: 'Eau + huile est un melange :', answer: 'heterogene', options: ['homogene', 'heterogene', 'chimique', 'pur'] }], timeLimit: 50, xp: 25 },
    ],
  },
  {
