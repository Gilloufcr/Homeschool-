...
export const englishLevels = [
  // ─── CE2 ─────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'ece2-1-t1', type: 'timed', question: 'Chrono ! Traduis ces salutations en anglais le plus vite possible !', challenges: [{ q: 'Comment dit-on "bonjour" en anglais ?', answer: 'Hello', options: ['Hello', 'Goodbye', 'Please', 'Sorry'] }, { q: 'Comment dit-on "au revoir" ?', answer: 'Goodbye', options: ['Hello', 'Goodbye', 'Thank you', 'Yes'] }, { q: 'Comment dit-on "merci" ?', answer: 'Thank you', options: ['Please', 'Sorry', 'Thank you', 'Hello'] }, { q: 'Comment dit-on "s\'il te plait" ?', answer: 'Please', options: ['Thank you', 'Sorry', 'Please', 'Goodbye'] }, { q: 'Comment dit-on "mon frere" ?', answer: 'my brother', options: ['my sister', 'my brother', 'my father', 'my friend'] }], timeLimit: 50, xp: 25 },
    ],
  },
  {
  ...
  // ─── CM1 ─────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'ecm1-1-t1', type: 'timed', question: 'Chrono ! Mots simples et salutations en anglais !', challenges: [{ q: 'Comment dit-on "oui" en anglais ?', answer: 'yes', options: ['yes', 'no', 'maybe', 'please'] }, { q: 'Comment dit-on "non" ?', answer: 'no', options: ['yes', 'no', 'not', 'none'] }, { q: 'Comment dit-on "je suis" ?', answer: 'I am', options: ['I am', 'I is', 'I have', 'I do'] }, { q: 'Que veut dire "What is your name?"', answer: 'Comment tu t\'appelles ?', options: ['Quel age as-tu ?', 'Comment tu t\'appelles ?', 'Ou habites-tu ?', 'Comment vas-tu ?'] }, { q: 'Comment dit-on "bonne nuit" ?', answer: 'Good night', options: ['Good morning', 'Good night', 'Good evening', 'Goodbye'] }], timeLimit: 50, xp: 25 },
    ],
  },
  {
  ...
  // ─── CM2 ─────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'ecm2-1-t1', type: 'timed', question: 'Chrono ! Le passe simple (past simple) des verbes reguliers !', challenges: [{ q: 'Quel est le passe de "play" ?', answer: 'played', options: ['played', 'plaied', 'plaid', 'playing'] }, { q: 'Quel est le passe de "watch" ?', answer: 'watched', options: ['watchd', 'watched', 'watcht', 'watching'] }, { q: 'Comment faire une phrase negative au passe ? "I ___ go."', answer: 'didn\'t', options: ['don\'t', 'didn\'t', 'not', 'wasn\'t'] }, { q: 'Quel est le passe de "cook" ?', answer: 'cooked', options: ['cooking', 'cookd', 'cooked', 'cooks'] }, { q: 'Complete : "___ you visit the museum yesterday?"', answer: 'Did', options: ['Do', 'Did', 'Does', 'Was'] }], timeLimit: 50, xp: 25 },
    ],
  },
  {
  ...
  // ─── 6eme ────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'e6e-1-t1', type: 'timed', question: 'Chrono ! Present simple ou present continuous ? Choisis la bonne forme !', challenges: [{ q: 'She ___ (read) a book right now.', answer: 'is reading', options: ['reads', 'is reading', 'read', 'reading'] }, { q: 'He ___ (go) to school every day.', answer: 'goes', options: ['is going', 'goes', 'go', 'going'] }, { q: 'Look! The cat ___ (sleep) on the sofa.', answer: 'is sleeping', options: ['sleeps', 'is sleeping', 'sleep', 'sleeping'] }, { q: 'We ___ (play) tennis on Saturdays.', answer: 'play', options: ['are playing', 'plays', 'play', 'playing'] }, { q: 'Listen! Someone ___ (knock) at the door.', answer: 'is knocking', options: ['knocks', 'is knocking', 'knock', 'knocked'] }], timeLimit: 50, xp: 25 },
    ],
  },
  {
  ...
  // ─── 5eme ────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'e5e-1-t1', type: 'timed', question: 'Chrono ! Present perfect - choisis la bonne reponse !', challenges: [{ q: 'I ___ never ___ to Japan.', answer: 'have / been', options: ['have / been', 'has / been', 'did / go', 'was / gone'] }, { q: 'She ___ already ___ the film.', answer: 'has / seen', options: ['have / seen', 'has / seen', 'did / see', 'is / seeing'] }, { q: 'Quel mot complete : "Have you ___ tried Indian food?"', answer: 'ever', options: ['never', 'ever', 'already', 'yet'] }, { q: 'Complete : "They haven\'t arrived ___."', answer: 'yet', options: ['already', 'ever', 'yet', 'never'] }, { q: 'Quel est le participe passe de "eat" ?', answer: 'eaten', options: ['ate', 'eaten', 'eating', 'eated'] }], timeLimit: 50, xp: 25 },
    ],
  },
  {
