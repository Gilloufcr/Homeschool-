...
export const historyLevels = [
  // ─── CE2 ─────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'hce2-1-t1', type: 'timed', question: 'Defi chrono : les grandes periodes de l\'histoire !', challenges: [{ q: 'Quelle periode vient apres la Prehistoire ?', answer: 'L\'Antiquite', options: ['Le Moyen Age', 'L\'Antiquite', 'Les Temps modernes', 'L\'Epoque contemporaine'] }, { q: 'Combien d\'annees dans un siecle ?', answer: '100 ans', options: ['10 ans', '100 ans', '1000 ans', '50 ans'] }, { q: 'L\'an 2024, c\'est quel siecle ?', answer: 'Le XXIe siecle', options: ['Le XXe siecle', 'Le XXIe siecle', 'Le XIXe siecle', 'Le XXIIe siecle'] }, { q: 'Que trouve-t-on dans les grottes de Lascaux ?', answer: 'Des peintures prehistoriques', options: ['Des fossiles', 'Des peintures prehistoriques', 'Des tresors', 'Des statues'] }, { q: 'Quel evenement marque le debut du Moyen Age ?', answer: 'La chute de Rome (476)', options: ['La Revolution francaise', 'La chute de Rome (476)', 'La decouverte de l\'Amerique', 'L\'invention de l\'ecriture'] }], timeLimit: 50, xp: 25 },
    ],
  },
  {
  ...
  // ─── CM1 ─────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'hcm1-1-t1', type: 'timed', question: 'Defi chrono : la Prehistoire et l\'Antiquite !', challenges: [{ q: 'Quelle grande decouverte a permis aux hommes prehistoriques de cuire les aliments ?', answer: 'Le feu', options: ['La roue', 'Le feu', 'Le fer', 'L\'electricite'] }, { q: 'Les premiers outils etaient fabriques en quoi ?', answer: 'Pierre taillee', options: ['Fer', 'Pierre taillee', 'Bronze', 'Bois'] }, { q: 'Comment appelle-t-on les gens qui se deplacent sans cesse pour trouver leur nourriture ?', answer: 'Des nomades', options: ['Des sedentaires', 'Des nomades', 'Des agriculteurs', 'Des artisans'] }, { q: 'Quel monument megalithique celebre se trouve en Bretagne ?', answer: 'Les menhirs de Carnac', options: ['Les pyramides', 'Les menhirs de Carnac', 'Le Colisee', 'Le Parthenon'] }, { q: 'Qu\'est-ce qui a permis aux humains de devenir sedentaires ?', answer: 'L\'invention de l\'agriculture', options: ['La chasse', 'L\'invention de l\'agriculture', 'La peche', 'La guerre'] }], timeLimit: 50, xp: 25 }
    ],
  },
  {
  ...
  // ─── CM2 ─────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'hcm2-1-t1', type: 'timed', question: 'Defi chrono : la Revolution francaise !', challenges: [{ q: 'En quelle annee a eu lieu la prise de la Bastille ?', answer: '1789', options: ['1776', '1789', '1793', '1815'] }, { q: 'Quelle est la devise de la Republique francaise ?', answer: 'Liberte, Egalite, Fraternite', options: ['Travail, Famille, Patrie', 'Liberte, Egalite, Fraternite', 'Force et Honneur', 'Unite et Progres'] }, { q: 'Quel roi a ete execute pendant la Revolution ?', answer: 'Louis XVI', options: ['Louis XIV', 'Louis XV', 'Louis XVI', 'Napoleon'] }, { q: 'Quel texte fondamental a ete redige en 1789 ?', answer: 'La Declaration des Droits de l\'Homme', options: ['La Constitution', 'La Declaration des Droits de l\'Homme', 'Le Code civil', 'Le traite de Versailles'] }, { q: 'Quels etaient les trois ordres de la societe avant la Revolution ?', answer: 'Clerge, noblesse, tiers-etat', options: ['Roi, princes, paysans', 'Clerge, noblesse, tiers-etat', 'Soldats, marchands, paysans', 'Seigneurs, vassaux, serfs'] }], timeLimit: 50, xp: 25 }
    ],
  },
  {
  ...
  // ─── 6eme ────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'h6e-1-t1', type: 'timed', question: 'Defi chrono : les civilisations antiques !', challenges: [{ q: 'Sur quel continent sont apparus les premiers humains ?', answer: 'L\'Afrique', options: ['L\'Europe', 'L\'Asie', 'L\'Afrique', 'L\'Amerique'] }, { q: 'Quel peuple a invente l\'ecriture cuneiforme ?', answer: 'Les Sumeriens', options: ['Les Egyptiens', 'Les Sumeriens', 'Les Grecs', 'Les Romains'] }, { q: 'En Egypte, comment s\'appelaient les grands tombeaux des pharaons ?', answer: 'Les pyramides', options: ['Les temples', 'Les pyramides', 'Les obelisques', 'Les sphinx'] }, { q: 'Quelle civilisation a invente la democratie ?', answer: 'Les Grecs (Athenes)', options: ['Les Romains', 'Les Grecs (Athenes)', 'Les Egyptiens', 'Les Perses'] }, { q: 'Quel fleuve etait vital pour la civilisation egyptienne ?', answer: 'Le Nil', options: ['Le Tigre', 'L\'Euphrate', 'Le Nil', 'Le Danube'] }], timeLimit: 50, xp: 25 }
    ],
  },
  {
  ...
  // ─── 5eme ────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'h5e-1-t1', type: 'timed', question: 'Defi chrono : l\'Empire byzantin et le Moyen Age !', challenges: [{ q: 'Quelle ville etait la capitale de l\'Empire byzantin ?', answer: 'Constantinople', options: ['Rome', 'Constantinople', 'Athenes', 'Alexandrie'] }, { q: 'L\'Empire byzantin est la continuation de quel empire ?', answer: 'L\'Empire romain d\'Orient', options: ['L\'Empire romain d\'Occident', 'L\'Empire romain d\'Orient', 'L\'Empire perse', 'L\'Empire grec'] }, { q: 'En quelle annee Constantinople est-elle tombee ?', answer: '1453', options: ['476', '1066', '1453', '1789'] }, { q: 'Quel empereur byzantin a fait compiler le droit romain ?', answer: 'Justinien', options: ['Constantin', 'Justinien', 'Theodose', 'Heraclius'] }, { q: 'Comment s\'appelle la celebre basilique de Constantinople ?', answer: 'Sainte-Sophie', options: ['Saint-Pierre', 'Sainte-Sophie', 'Notre-Dame', 'Saint-Marc'] }], timeLimit: 50, xp: 25 }
    ],
  },
  {
