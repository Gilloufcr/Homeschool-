...
export const geographyLevels = [
  // ─── CE2 ─────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'gce2-1-t1', type: 'timed', question: 'Reponds vite ! Les bases de la carte et de l\'orientation', challenges: [{ q: 'Quel point cardinal est en haut d\'une carte ?', answer: 'Nord', options: ['Nord', 'Sud', 'Est', 'Ouest'] }, { q: 'Quel outil indique le Nord ?', answer: 'La boussole', options: ['La boussole', 'La regle', 'Le compas', 'La loupe'] }, { q: 'Quelle est la capitale de la France ?', answer: 'Paris', options: ['Paris', 'Lyon', 'Marseille', 'Toulouse'] }, { q: 'Combien y a-t-il de points cardinaux ?', answer: '4', options: ['2', '3', '4', '6'] }, { q: 'A quoi sert la legende d\'une carte ?', answer: 'Expliquer les symboles', options: ['Decorer la carte', 'Expliquer les symboles', 'Donner la date', 'Indiquer le prix'] }], timeLimit: 50, xp: 25 },
    ],
  },
  {
  ...
  // ─── CM1 ─────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'gcm1-1-t1', type: 'timed', question: 'Reponds vite ! Les regions et villes de France', challenges: [{ q: 'Combien de regions en France metropolitaine ?', answer: '13', options: ['10', '13', '18', '22'] }, { q: 'Quelle est la capitale de la region Occitanie ?', answer: 'Toulouse', options: ['Montpellier', 'Toulouse', 'Bordeaux', 'Marseille'] }, { q: 'Dans quelle region se trouve Paris ?', answer: 'Ile-de-France', options: ['Ile-de-France', 'Centre-Val de Loire', 'Hauts-de-France', 'Normandie'] }, { q: 'Quelle ville est la capitale de la region Auvergne-Rhone-Alpes ?', answer: 'Lyon', options: ['Lyon', 'Clermont-Ferrand', 'Grenoble', 'Saint-Etienne'] }, { q: 'Combien de departements en France metropolitaine ?', answer: '96', options: ['50', '75', '96', '101'] }], timeLimit: 50, xp: 25 },
    ],
  },
  {
  ...
  // ─── CM2 ─────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'gcm2-1-t1', type: 'timed', question: 'Reponds vite ! Communication et deplacements dans le monde', challenges: [{ q: 'Comment appelle-t-on les inegalites d\'acces a internet ?', answer: 'La fracture numerique', options: ['Le bug mondial', 'La fracture numerique', 'La panne generale', 'Le piratage'] }, { q: 'Par ou passent les donnees internet entre les continents ?', answer: 'Des cables sous-marins', options: ['Des satellites uniquement', 'Des cables sous-marins', 'Des avions', 'Des pigeons voyageurs'] }, { q: 'Dans les pays en developpement, internet se diffuse surtout grace a quoi ?', answer: 'Le telephone mobile', options: ['L\'ordinateur fixe', 'Le telephone mobile', 'La tablette', 'La television'] }, { q: 'Comment s\'appelle le travail depuis la maison ?', answer: 'Le teletravail', options: ['Le teletravail', 'Le coworking', 'Le stage', 'Le benevolat'] }, { q: 'Dans quelle zone climatique se situe la France ?', answer: 'Zone temperee', options: ['Zone tropicale', 'Zone temperee', 'Zone polaire', 'Zone aride'] }], timeLimit: 50, xp: 25 },
    ],
  },
  {
  ...
  // ─── 6eme ────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'g6e-1-t1', type: 'timed', question: 'Reponds vite ! Geographie mondiale : continents, oceans et grandes villes', challenges: [{ q: 'Combien y a-t-il de continents ?', answer: '6', options: ['4', '5', '6', '8'] }, { q: 'Quel est le plus grand ocean du monde ?', answer: 'L\'ocean Pacifique', options: ['L\'ocean Atlantique', 'L\'ocean Pacifique', 'L\'ocean Indien', 'L\'ocean Arctique'] }, { q: 'Quelle est la ville la plus peuplee du monde ?', answer: 'Tokyo', options: ['New York', 'Tokyo', 'Paris', 'Londres'] }, { q: 'Sur quel continent se trouve l\'Egypte ?', answer: 'L\'Afrique', options: ['L\'Asie', 'L\'Europe', 'L\'Afrique', 'L\'Amerique'] }, { q: 'Quel continent est le plus grand en superficie ?', answer: 'L\'Asie', options: ['L\'Afrique', 'L\'Asie', 'L\'Europe', 'L\'Amerique'] }], timeLimit: 50, xp: 25 },
    ],
  },
  {
  ...
  // ─── 5eme ────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'g5e-1-t1', type: 'timed', question: 'Reponds vite ! Developpement et ressources dans le monde', challenges: [{ q: 'Combien d\'habitants sur Terre environ ?', answer: 'Plus de 8 milliards', options: ['3 milliards', '5 milliards', 'Plus de 8 milliards', '12 milliards'] }, { q: 'Sur quel continent la population augmente le plus vite ?', answer: 'L\'Afrique', options: ['L\'Europe', 'L\'Asie', 'L\'Afrique', 'L\'Amerique'] }, { q: 'Comment appelle-t-on le passage d\'une forte a une faible natalite ?', answer: 'La transition demographique', options: ['L\'exode rural', 'La transition demographique', 'La mondialisation', 'L\'urbanisation'] }, { q: 'Quel pourcentage de l\'eau sur Terre est de l\'eau douce ?', answer: '3%', options: ['3%', '30%', '50%', '75%'] }, { q: 'Que mesure l\'esperance de vie ?', answer: 'Le nombre moyen d\'annees de vie', options: ['La richesse d\'un pays', 'Le nombre moyen d\'annees de vie', 'Le nombre d\'enfants', 'La taille du pays'] }], timeLimit: 50, xp: 25 },
    ],
  },
  {
